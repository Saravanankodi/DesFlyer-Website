...
function Journey() {
  return (
    <>
    <section className="w-full h-auto p-5 border-y-2 border-primary">
        <header className="w-full lg:w-3/4 lg:p-5">
            <h2 className="heading text-3xl text-center lg:text-left lg:text-6xl">
              Discover DesFlyer  Journey
            </h2>
            <p className="text lg:w-4/5 lg:my-2.5 text-lg lg:text-xl text-justify">
        ...
        <main className="w-full h-auto block lg:grid grid-cols-3 lg:p-5 gap-5 ">
          {data.map((item,index)=>(
              <DetailesCard
              key={index}
              tittle={item.tittle}
