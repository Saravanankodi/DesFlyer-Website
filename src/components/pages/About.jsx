...
function About() {
  return (
    <>
    <section className="w-full lg:flex p-5">
        <main className="w-full lg:w-3/5">
            <header className="w-full">
                <h2 className="heading text-3xl lg:text-5xl text-center my-2.5 lg:text-left">
                    Our Journey and Team
                </h2>
                <p className="text text-lg lg:text-xl text-justify">
            ...
            <div className="w-full lg:grid grid-cols-2 grid-rows-2 gap-5 py-2.5">
                {data.map((item,index)=>(
                    <div className="w-full my-2 lg:m-0" key={index}>
                        <h2 className="heading text-3xl text-center lg:text-left">
                            {item.tittle}
                        </h2>
